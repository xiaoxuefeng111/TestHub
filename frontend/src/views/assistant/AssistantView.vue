    ...
    <div class="main-content">
      ...
      <div v-else class="chat-screen">
        <div class="chat-header">
          ...
          <span v-if="currentSession" class="chat-time">{{
        ...
        <div ref="messagesContainer" class="messages-container">
          ...
          >
            ...
            <div class="message-bubble">
              ...
              ></div>
              <div v-if="message.isPending" class="message-status">
...
const logoutLabel = computed(() => {
  return LOCAL_DEV_AUTH_ENABLED ? "重置本地会话" : t("assistant.logout");
});
...
const logoutSuccessText = computed(() => {
  return LOCAL_DEV_AUTH_ENABLED ? "本地会话已重置" : t("assistant.loggedOut");
});

const logoutTitle = computed(() => {
  return LOCAL_DEV_AUTH_ENABLED ? "本地模式" : t("assistant.logoutTitle");
});
...
const handleLogout = () => {
  ElMessageBox.confirm(logoutConfirmText.value, logoutTitle.value, {
