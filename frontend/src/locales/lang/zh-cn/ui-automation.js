export default {
  ...
  ai: {
    ...
    on: "开启",
    off: "关闭",
    gifTip: "开启后将录制执行过程并生成GIF文件，保存到 media/ai_recording 目录",
    startExecution: "开始执行",
    stopExecution: "停止执行",
    saveAsCase: "保存为用例",
    tip: "提示",
    ...
    executionReport: {
      ...
      gifRecording: "GIF 录屏",
      noGif: "GIF未生成",
      noReportData: "当前执行暂无可生成的报告数据",
      noReportDataTitle: "暂无报告",
      ...
      messages: {
        loadFailed: "获取报告失败",
        loadFailedWithReason: "报告加载失败：{reason}",
        serverError: "报告加载失败：服务器内部错误",
        networkError: "报告加载失败：网络异常，请稍后重试",
        notFound: "未找到执行记录",
