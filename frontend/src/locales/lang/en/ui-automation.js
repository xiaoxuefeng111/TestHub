export default {
  ...
  ai: {
    ...
    taskPlaceholder:
      "Describe the task in natural language, e.g.:\n1. Visit https://www.baidu.com\n2. Search 'Tongdaxin Testing Platform'\n3. Click the first search result",
    gifRecording: "GIF Recording",
    on: "On",
    off: "Off",
    gifTip:
      "When enabled, the execution process will be recorded as a GIF file and saved to the media/ai_recording directory",
    startExecution: "Start Execution",
    ...
    executionReport: {
      ...
      noReportData: "No report can be generated for this execution yet",
      noReportDataTitle: "No Report Available",
      ...
      messages: {
        ...
        loadFailedWithReason: "Failed to load report: {reason}",
        serverError: "Failed to load report: Internal server error",
        networkError:
          "Failed to load report: Network error, please try again later",
